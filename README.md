...
Работа с коллекциями, функциями и компонентной структурой JavaScript-приложения. Необходимо доработать приложение с карточками и страницей «Подробнее», а также выполнить дополнительное задание: сделать видео или GIF-анимацию вместо 3D-модели.
